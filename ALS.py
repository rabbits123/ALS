...
# Load file ratings.csv bao gồm trường userID, movieID, rating, timestamp
...
# 1. Lọc ra những dòng khác header
# 2. tách mỗi dòng thành 1 mảng dựa theo ","
# 3. lọc ra trường timestamp
...
# Load file Movies.csv gồm trường movieID, title, genres
